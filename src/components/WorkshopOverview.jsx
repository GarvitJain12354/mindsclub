  ...
  return (
    <>
      ...
      <div className="w-screen min-h-screen bg-white overflow-hidden">
        <main id="container" className="relative " ref={containerRef}>
          <div className="w-full first-section relative">
            <section className="horizontal-section  bg-[#FFFE81]">
              {/* <DayOneSection1 /> */}
              <div className="w-full flex flex-col px-10 pt-10 h-[85%] shrink-0">
                <div className="flex justify-between items-start px-4 pb-2">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-xl text-black font-medium">
                      <span className="rotate-[-45deg] text-sm font-bold">
                        ✈
                      </span>
                      <span>The Arrival</span>
                    </div>
                ...
                <div
                  id="inner"
                  className="w-full flex h-full items-start overflow-x-hidden overflow-y-hidden relative mt-10"
                >
                  <div className="w-1/2 hori h-full shrink-0 flex gap-2 items-start justify-end ">
                    <img
                      src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop&crop=center"
            ...
            <section className="horizontal-section  bg-[#FFFE81]">
              ...
              <div className="w-full flex flex-col px-10 pt-10 h-[85%] shrink-0">
                ...
                <div
                  ...
                  className="w-full flex h-full items-start overflow-x-hidden overflow-y-hidden relative mt-10"
                >
                  <div className="w-1/2  h-full shrink-0 flex gap-2 items-start justify-end ">
                    <img
                      src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop&crop=center"
                      alt="Welcome drink"
                      className="w-full max-w-[200px] h-[280px] rounded-lg object-cover shadow-lg mb-3"
                  ...
                  <div className="w-1/2  h-full shrink-0 flex flex-col items-end justify-end">
                    <img
                      src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=350&fit=crop&crop=center"
                      alt="Hotel room"
                      className="w-full max-w-[25vw] h-[25vw] rounded-lg object-cover shadow-lg mb-3"
                  ...
                  <div className="w-1/2  h-full mt-20 shrink-0 flex flex-col gap-2 items-center justify-center ">
                    <img
                      src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop&crop=center"
                      alt="Welcome drink"
                      className="w-full max-w-[280px] h-[280px] rounded-lg object-cover shadow-lg mb-3"
                  ...
                  <div className="w-1/2  h-full shrink-0 flex flex-col items-center justify-start">
                    <img
                      src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=350&fit=crop&crop=center"
                      alt="Hotel room"
                      className="w-full max-w-[10vw] h-[15vw] rounded-lg object-cover shadow-lg mb-3"
                  ...
                  <div className="w-1/2  h-full  shrink-0 flex flex-col gap-2 items-center justify-center ">
                    <img
                      src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop&crop=center"
                      alt="Welcome drink"
                      className="w-full max-w-[250px] h-[280px] rounded-lg object-cover shadow-lg mb-3"
                  ...
                  <div className="w-1/2  h-full shrink-0 flex flex-col items-center justify-center mt-10">
                    <img
                      src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=350&fit=crop&crop=center"
                      alt="Hotel room"
                      className="w-full max-w-[25vw] h-[25vw] rounded-lg object-cover shadow-lg mb-3"
          ...
          <section className="horizontal-section">
            ...
            <div className="bg-[#FFFE81] w-screen border-t border-black/30  pb-3 absolute bottom-0 left-0">
              <div className="flex justify-around px-4 items-center h-full py-5">
                <div className="relative">
                  <span className="text-xs font-bold text-black tracking-wider">
                    ARRIVAL
