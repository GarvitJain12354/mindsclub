  ...
  return (
    <div className="w-full h-screen bg-[#FFFE81] relative overflow-hidden">
      ...
      <div className="w-full block md:hidden h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-row justify-center pb-16">
          
          {/* Planning Session Section - Left aligned */}
          <div className="w-1/2 h-full flex flex-col items-start justify-end">
            <img
            ...
            />
            <p className="max-w-[200px] pl-5 text-start font-medium text-sm text-black leading-relaxed">
              Planning session<br />
              with the team.
            </p>
          </div>

          {/* Evening Dinner Section - Right aligned */}
          <div className="w-1/2 h-full flex flex-col items-end justify-start pr-10">
            <img
              src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=300&h=350&fit=crop&crop=center"
              alt="Delicious dinner"
              className="w-full max-w-[150px] h-[240px] rounded-lg object-cover shadow-lg mb-3"
            />
            <p className="pr-10 text-start font-medium text-sm text-black leading-relaxed">
              Enjoy your<br />
              delicious dinner.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <div className="relative w-[80px] h-2 bg-white/60 rounded-full">
            <div className="absolute left-4 top-0.5 w-5 h-1 bg-orange-400 rounded-full"></div>
          </div>
        </div>
      ...
      <div className="hidden md:block px-8 py-8 md:px-10 md:py-10 lg:px-12 lg:py-12 xl:px-16 xl:py-16 2xl:px-20 2xl:py-20 h-full">
        ...
        <div className="flex-1 flex justify-between items-center gap-8 lg:gap-10 xl:gap-12 mb-12 lg:mb-16">
          ...
          {/* Left: Planning Session (opposite of DayOne's intro session position) */}
          ...
          {/* Right: Delicious Dinner (opposite of DayOne's chit-chat position) */}
        ...
        <div className="flex flex-col items-center mb-8 lg:mb-10">
          ...
          <div className="relative w-[100px] lg:w-[120px] xl:w-[140px] h-3 lg:h-3.5 bg-white/60 rounded-full">
            <div className="absolute left-4 top-0.5 w-7 lg:w-8 xl:w-9 h-2 lg:h-2.5 bg-orange-400 rounded-full"></div>
          </div>
        </div>
