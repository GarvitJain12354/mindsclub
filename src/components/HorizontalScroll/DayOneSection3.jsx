  ...
  return (
    <div className="w-full h-screen bg-[#FFFE81] relative overflow-hidden">
      ...
      <div className="w-full block md:hidden h-full flex flex-col">
        {/* Header Section */}
        <div className="flex justify-between items-start px-4 pt-24">
          {/* Left: Day Title */}
          <div>
        ...
        <div className="flex-1 flex flex-row justify-center pb-16">
          ...
          {/* Intro Session Section - Left aligned */}
          ...
          {/* Evening Chit-chat Section - Right aligned */}
          <div className="w-1/2 h-full flex flex-col items-end justify-end">
            <img
              ...
              alt="Evening chit-chat"
              className="w-full max-w-[150px] h-[240px] rounded-tl-lg rounded-bl-lg object-cover shadow-lg mb-3"
            />
            <p className="pr-2 text-start font-medium text-sm text-black leading-relaxed">
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <div className="relative w-[80px] h-2 bg-white/60 rounded-full">
            <div className="absolute left-0.5 top-0.5 w-5 h-1 bg-orange-400 rounded-full"></div>
          </div>
        </div>
      ...
      <div className="hidden md:block px-8 py-8 md:px-10 md:py-10 lg:px-12 lg:py-12 xl:px-16 xl:py-16 2xl:px-20 2xl:py-20 h-full">
        ...
        <div className="flex flex-col items-center mb-8 lg:mb-10">
          ...
          <div className="relative w-[100px] lg:w-[120px] xl:w-[140px] h-3 lg:h-3.5 bg-white/60 rounded-full">
            <div className="absolute left-0.5 top-0.5 w-7 lg:w-8 xl:w-9 h-2 lg:h-2.5 bg-orange-400 rounded-full"></div>
          </div>
        </div>
