        ...
        <div className="w-full h-full flex-1 flex flex-row items-center justify-between pb-16">
          ...
          <div className="w-1/2 h-full flex flex-col items-start justify-start pt-10 pl-2">
            <img
              ...
              alt="Welcome drink"
              className="w-full max-w-[150px] h-[200px] rounded-lg object-cover shadow-lg mb-3"
            />
          ...
          {/* Right - Settle Into Room Section */}
          <div className="w-1/2 h-full flex flex-col items-end justify-end pb-24 mt-3">
            <img
      ...
      <div className="hidden md:block px-8 py-8 md:px-10 md:py-10 lg:px-12 lg:py-12 xl:px-16 xl:py-16 2xl:px-20 2xl:py-20 h-full">
        ...
        <div className="flex flex-col items-center mb-8 lg:mb-10">
          ...
          <div className="relative w-[100px] lg:w-[120px] xl:w-[140px] h-3 lg:h-3.5 bg-white/60 rounded-full">
            <div className="absolute left-1 top-0.5 w-7 lg:w-8 xl:w-9 h-2 lg:h-2.5 bg-orange-400 rounded-full"></div>
          </div>
        </div>
