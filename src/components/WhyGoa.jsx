  ...
  return (
    <div className="min-h-[42vh] md:min-h-[60vh] md:min-h-screen mb-10">
      ...
      <div className="pt-0 md:pt-16 pb-6 max-w-2xl text-center md:text-left pl-0 md:pl-10 mb-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 opacity-0 animate-fade-in text-center md:text-left">
          Why Goa?
        </h1>
      ...
      <div className="relative">
        ...
        <div 
          ...
          className="flex gap-4 pl-4 md:pl-12 pr-4 md:pr-8 overflow-x-auto scrollbar-hide"
          style={{ 
          ...
          {categories.map((category, index) => (
            <div
              ...
              className={`relative flex-shrink-0 rounded-2xl overflow-hidden cursor-pointer transition-all duration-500 ${
                hoveredCard === index ? 'z-10 -translate-y-1' : 'z-0'
              }`}
              style={{
                ...
                width: window.innerWidth < 768
                  ? (hoveredCard === null
                      ? (index === 0 ? '70vw' : '60vw')
                      : (hoveredCard === index ? '70vw' : '60vw'))
                  : getCardWidth(index),
                minWidth: window.innerWidth < 768 ? '180px' : '279px'
              }}
            ...
            >
              ...
              >
                <h3 
                  className={`text-lg sm:text-xl md:text-2xl font-bold mb-1 ${getTextColor(index)}`}
                  style={{
                ...
                <p 
                  className={`text-xs sm:text-sm md:text-base font-medium tracking-wider ${getTextColor(index)} transition-opacity duration-500 ${
